...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="conversation-wrap col-lg-3">
            ...
            @For Each m In Model
                @<div onclick="javascript:window.location.href = '@Url.Content("~")Messages?UserName=@m.UserName'" class="media conversation">
        ...
        @Html.Action("Chat", New With {.ChatUser = ViewBag.ChatUser})
